...
Command: npx gltfjsx@6.1.4 baby_memory_scan.gltf --transform
Author: belltyler (https://sketchfab.com/belltyler)
License: CC-BY-4.0 (http://creativecommons.org/licenses/by/4.0/)
Source: https://sketchfab.com/3d-models/baby-memory-scan-e68d987aad524a39bdd409034f333020
Title: Baby Memory Scan
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/baby_memory_scan-transformed.glb')
  return (
...
useGLTF.preload('/baby_memory_scan-transformed.glb')
